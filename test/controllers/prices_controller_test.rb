...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { market_id: @price.market_id, product_id: @price.product_id, type: @price.type }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { market_id: @price.market_id, product_id: @price.product_id, type: @price.type }
    assert_redirected_to price_path(assigns(:price))
  end
