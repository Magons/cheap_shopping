...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { adress: @market.adress, description: @market.description, name: @market.name }
    end
  ...
  test "should update market" do
    patch :update, id: @market, market: { adress: @market.adress, description: @market.description, name: @market.name }
    assert_redirected_to market_path(assigns(:market))
  end
